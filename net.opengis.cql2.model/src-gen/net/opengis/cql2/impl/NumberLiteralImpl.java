 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.cql2.impl.NumberLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumberLiteralImpl extends LiteralImpl implements NumberLiteral {
	...
	protected EClass eStaticClass() {
		return Cql2Package.Literals.NUMBER_LITERAL;
	}
	...
	public void setValue(BigDecimal newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cql2Package.NUMBER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cql2Package.NUMBER_LITERAL__VALUE:
				return getValue();
		}
