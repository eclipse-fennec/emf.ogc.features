 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.cql2.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralImpl extends LiteralImpl implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return Cql2Package.Literals.STRING_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cql2Package.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cql2Package.STRING_LITERAL__VALUE:
				return getValue();
		}
