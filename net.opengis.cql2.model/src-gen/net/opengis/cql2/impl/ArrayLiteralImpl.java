 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.cql2.impl.ArrayLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayLiteralImpl extends LiteralImpl implements ArrayLiteral {
	...
	protected EClass eStaticClass() {
		return Cql2Package.Literals.ARRAY_LITERAL;
	}
	...
	public EList<Expression> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Expression>(Expression.class, this, Cql2Package.ARRAY_LITERAL__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Cql2Package.ARRAY_LITERAL__ELEMENTS:
