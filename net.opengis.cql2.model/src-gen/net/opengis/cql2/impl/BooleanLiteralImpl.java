 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.cql2.impl.BooleanLiteralImpl#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralImpl extends LiteralImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return Cql2Package.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cql2Package.BOOLEAN_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Cql2Package.BOOLEAN_LITERAL__VALUE:
				return isValue();
		}
