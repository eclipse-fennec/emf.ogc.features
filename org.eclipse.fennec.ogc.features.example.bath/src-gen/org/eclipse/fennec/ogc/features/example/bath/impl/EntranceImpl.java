 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.ogc.features.example.bath.impl.EntranceImpl#isMain <em>Main</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntranceImpl extends AssetImpl implements Entrance {
	/**
	...
	protected EClass eStaticClass() {
		return BathPackage.Literals.ENTRANCE;
	}
	...
	public void setMain(boolean newMain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BathPackage.ENTRANCE__MAIN, oldMain, main));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BathPackage.ENTRANCE__MAIN:
				return isMain();
		}
