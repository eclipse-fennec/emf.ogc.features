...
/**
 * The leisure pool demo on H2: data source, mapping derived from the model, persistence
 * unit bound to the geojson converter, repository, demo data loader and a repository
 * feature source.
 */
...
@WithConfiguration(pid = "org.eclipse.fennec.ogc.features.example.bath.loader", location = "?", properties = {
		...
		@Property(key = "dataSource.target", value = "(objectClass=javax.sql.DataSource)") })
